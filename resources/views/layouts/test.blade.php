...
<body
    class="bg-background h-screen overflow-hidden flex flex-col lg:flex-row"
    x-data="{
        open: false,
...
>
    ...
    <header
        class="lg:hidden bg-gray-800 text-white p-4 flex justify-between items-center shrink-0"
    >
